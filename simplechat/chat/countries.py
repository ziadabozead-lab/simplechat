"""
Country dial-code data for phone number fields.
Each entry: (ISO 3166-1 alpha-2 code, country name, calling code without '+').
Generated once from the `phonenumbers` + `pycountry` libraries; this file has
no runtime dependency on either package.
"""
...
# Convenient (value, label) choices for a Django form field, e.g.:
#   ("EG", "Egypt (+20)")
COUNTRY_CHOICES = [(iso2, f"{name} (+{code})") for iso2, name, code in COUNTRIES]

DIAL_CODE_BY_ISO2 = {iso2: code for iso2, name, code in COUNTRIES}